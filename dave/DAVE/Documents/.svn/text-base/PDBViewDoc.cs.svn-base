...
namespace UoB.DAVE.Documents
{
	...
	public sealed class PDBViewDoc : PSViewDoc
	{
		...
		private UoB.CoreControls.ToolWindows.Model_Scroll m_ModelScroll;
		private PDB m_PDB;
		...
		{
			this.m_ModelScroll = new UoB.CoreControls.ToolWindows.Model_Scroll();
			this.SuspendLayout();
			// 
			// m_ModelScroll
			// 
