...
namespace UoB.DAVE.Documents
{
	...
	public sealed class DirectoryViewDoc : Document
	{
		...
		private UoB.Generic.ToolWindows.Tra_Scroll_Extended tra_Scroll_Extended;
		private UoB.Generic.Controls.DirectoryFileSelection directoryFileSelection;
		...
		private FileType_Structural m_FileType_Structural = null;
		...
		public FileType_Structural CurrentViewItem
		{
			get
			{
		...
		{
			this.tra_Scroll_Extended = new UoB.Generic.ToolWindows.Tra_Scroll_Extended();
			this.panel_Viewer = new System.Windows.Forms.Panel();
			this.panel_Bottom = new System.Windows.Forms.Panel();
			this.panel1 = new System.Windows.Forms.Panel();
			this.splitter_Bottom = new System.Windows.Forms.Splitter();
			this.directoryFileSelection = new UoB.Generic.Controls.DirectoryFileSelection();
