...
namespace UoB.Methodology.DSSPAnalysis.AngleFitting
{
	...
	public class AngleFittingEngineOutputConverter : DSSPTaskDirecory_PhiPsiData
	{
		...
		private double[] m_FittedPhis = null;
		private double[] m_FittedPsis = null;
		private double[] m_Omegas = null;
		private float[] m_Propensities = null;
		private RamachandranBound[]  m_AngleBoundClasses = null;

		// IO Streams
		private StreamReader m_AngleStream = null; // used to read each of the .CSV angle output files
		...
		private void ObtainAngleFitDataSet( int angleCount, DSSPReportingOn reportOn, StandardResidues resTypes, bool sortByOriginalAngles )
		{
