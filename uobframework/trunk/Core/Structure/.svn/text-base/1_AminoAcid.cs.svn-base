	...
	public class AminoAcid : Molecule, ICloneable
	{
        ...
        public float omgAngle
        {
            get
            {
                ...
                AminoAcid prevAA = m_Parent.previousMolecule(this) as AminoAcid;

                if (prevAA == null ||
                    prevAA.CAlphaAtom == null ||
                ...
                return Atom.MeasureTorsion(prevAA.CAlphaAtom, prevAA.CTerminalAtom, NTerminalAtom, CAlphaAtom);
            }
        }
		...
		public float psiAngle
		{
			get
			{
                ...
                AminoAcid nextAA = m_Parent.nextMolecule(this) as AminoAcid;
