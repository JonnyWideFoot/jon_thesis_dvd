...
namespace UoB.Core.FileIO.DSSP
{
	...
	public class SegmentDef // can be a length of either loop or secondary structure
	{
        ...
        private char m_NTerminalDSSPType = '-';
        private char m_CTerminalDSSPType = '-';
        ...
        public char NTerminalDSSPType
        {
            get
            {
                return m_NTerminalDSSPType;
            }
            set
            {
                m_NTerminalDSSPType = value;
            }
        }

        public char CTerminalDSSPType
        {
            get
            {
                return m_CTerminalDSSPType;
            }
            set
            {
                m_CTerminalDSSPType = value;
            }
        }
