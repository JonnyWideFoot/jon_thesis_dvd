...
namespace UoB.Core.Tools
{
	...
	public class ArrayTools
	{
        ...
        public static void TransposeCSV( string inputFile, string outputFile )
        {
            List<string[]> strings = new List<string[]>();
            StreamReader re = new StreamReader(inputFile);
            string line;
            int maxLength = 0;
            ...
            re.Close();
            StreamWriter rw = new StreamWriter(outputFile);
