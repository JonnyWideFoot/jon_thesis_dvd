...
{
	public delegate void DownloadProgressHandler(int bytesRead, int totalBytes, int threadnumber);
	...
	public class WebDownload
	{
		...
		public WebDownload(int threadNumber)
		{
		...
		private void ReadCallBack(IAsyncResult asyncResult)
		{
			...
			if (bytesRead > 0)
			{
				...
				if ( info.ProgressCallback != null )
					info.ProgressCallback( info.bytesProcessed, info.dataLength, m_threadNumber);
